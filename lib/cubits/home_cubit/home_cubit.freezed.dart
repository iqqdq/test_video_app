...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(final List<Video> videos) : _videos = videos;
...
abstract class _Success implements HomeState {
  const factory _Success(final List<Video> videos) = _$SuccessImpl;
...
class __$$AlertImplCopyWithImpl<$Res>
    extends _$HomeStateCopyWithImpl<$Res, _$AlertImpl>
...
class _$AlertImpl implements _Alert {
  const _$AlertImpl(this.message);
  ...
  @override
  String toString() {
    return 'HomeState.alert(message: $message)';
  }
...
abstract class _Alert implements HomeState {
  const factory _Alert(final String? message) = _$AlertImpl;
